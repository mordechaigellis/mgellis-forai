...
;with x as(
   select RecipeName = 'Chocolate Chip Cookies', Cuisine = 'American', Amount = 1, MeasurementType = 'cup', Ingredient = 'sugar', SequenceVal = 1
   union select 'Chocolate Chip Cookies', 'American', 0.5, 'cup', 'oil', 2
   union select 'Chocolate Chip Cookies', 'American', 3, null, 'eggs', 3
   ...
   union select 'Cheese Bread', 'English', 2, 'clove', 'garlic',4
   ...
   union select '360-Minute Steak', 'American', 2, null,'onions',3
   ...
   union select 'Roasted Vegetable Yapchik', 'English', 4, null, 'eggs',11
   union select 'Roasted Vegetable Yapchik', 'English', 1,'pound', 'boneless flanken',12
...
insert RecipeIngredient(RecipeId,MeasurementId,IngredientId,MeasurementQty,SequenceVal)
select r.RecipeId,m.MeasurementId,i.IngredientId,x.Amount,x.SequenceVal
from x
join Ingredient i
